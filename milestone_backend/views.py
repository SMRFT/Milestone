...
def get_all_assessments(request):
    client = MongoClient('mongodb+srv://milestone:Smrft%402024@cluster0.nrx0f.mongodb.net/')
...
def DevelopmentalTask(request):
    ...
    client = MongoClient(f'mongodb+srv://milestone:{password}@cluster0.nrx0f.mongodb.net/')
